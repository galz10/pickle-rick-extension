...
async function main() {
  ...
  log(
    `Promises: hasPromise=${hasPromise}, isEpicDone=${isEpicDone}, isTaskFinished=${isTaskFinished}, isWorkerDone=${isWorkerDone}, isTicketDone=${isTicketDone}, isTaskDone=${isTaskDone}, isBreakdownDone=${isBreakdownDone}`
  );
